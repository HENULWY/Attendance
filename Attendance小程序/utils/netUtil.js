...
function request(requestConfig){
  ...
  // var openId = wx.getStorageSync('openId');
    ...
    if (wholeUrl.indexOf("http://") <0||wholeUrl.indexOf("https://") <0){
      ...
      wholeUrl = "http://localhost/attendance/" + requestConfig.urlTail;
    }

    var contentType ='';
    var weChat = wx.getStorageSync('openId');
    var body = undefined;
    ...
    wx.request({
        ...
        data:{
          body,
          pageIndex: requestConfig.params.pageIndex,
          userWechat: weChat
        },
