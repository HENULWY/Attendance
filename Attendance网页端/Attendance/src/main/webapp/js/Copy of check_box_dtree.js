...
dTree.prototype.checkNode = function(id,pid,_hc,checked) {
	...
	alert(" 255 !this.isHaveBNode(id,pid) : " + !this.isHaveBNode(id,pid));
		if(checked){
			//选中就一直选到根节点
...
dTree.prototype.checkPNodeRecursion = function(pid,ischecked) {	
	...
	for (var n=0; n<this.aNodes.length; n++) {
		...
		if (this.aNodes[n].pid!=-1&&this.aNodes[n].id == pid) {			
			...
			//alert("305 document.all."+ this.aNodes[n].id + ".checked = " + ischecked);
...
dTree.prototype.checkSNodeRecursion = function(id,ischecked) {	
	...
	for (var n=0; n<this.aNodes.length; n++) { alert("332 = n = " + n + " id = " + id + " #### this.aNodes[n].pid = " + this.aNodes[n].pid );
