...
function writeIframe()
{
  ...
  //      strIframe +="<td colspan=1 class=out title='"+ "清空" +"'><input style=' background-color: "+
//         WebCalendar.btnBgColor +";cursor: hand; padding-top: 4px; width: 50%; height: 100%; border: 0' onfocus='this.blur()'"+
//         " type=button value='清空' onclick='parent.hiddenCalendar()'></td>";
//       strIframe +="<td colspan=3 class=out title='"+ WebCalendar.regInfo +"'><input style=' background-color: "+
         strIframe +="<td colspan=2 class=out title='"+ "关闭" +"'><input style=' background-color: "+
